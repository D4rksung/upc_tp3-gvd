...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet" type="text/css"><link href="<?php echo getUrl(); ?>/css/estilos.css?rnd=<?php echo $random; ?>" rel="stylesheet" type="text/css">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"><img src="<?php echo getUrl(); ?>\images\img\logo.png"/></a>
    </div>
...
<div class="jumbotron text-center">
  <h1>Pet Center</h1> 
  <p>Clínica veterinaria especializada en mascotas 
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>Nosotros</h2><br>
      <h4>PET CENTER es la primera cadena importante de veterinarias del Perú</h4><br>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <h4><strong>Misión:</strong> CLINICA VETERINARIA PET CENTER tiene como misión ofrecer servicios médicos veterinarios de óptima calidad, Amplia experiencia y un excelente trato a su mascota.</h4><br>
...
$(document).ready(function(){
    ...
    <?php  if(isset($_SESSION["ENTRO_SESSION"])){ ?> 
                  alert('Usuario y/o incorrecto.');
              <?php  unset($_SESSION['ENTRO_SESSION']); }  ?> 
                    ...
                    <form id="login-form" action="main/usuario" method="POST">
		                <div class="modal-body">
				    		<div id="div-login-msg">
                                ...
                                <span id="text-login-msg">Ingresar usuario y contraseña.</span>
                            </div>
				    		<input name="login_username" id="login_username" class="form-control" type="text" placeholder="Usuario" required>
				    		<input name="login_password" id="login_password" class="form-control" type="password" placeholder="Contraseña" required>
