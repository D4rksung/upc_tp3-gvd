...
<section>
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <th>Resultado de Seguimiento</th>
                        ...
                        <?php
                        if(count($getSeguimiento) > 0){
                        foreach($getSeguimiento as $via2){?>                           
                               <tr>
                                   <td><?php echo $via2["fecharegistro"]?></td>
                                   <td><?php echo $via2["resultado"]?></td>
                                   <td><?php echo $via2["detalle"]?></td>
                                   <td><?php echo $via2["horaCita"]?></td>
                                   <td><?php echo $via2["estadoCita"]?></td>
                        ...
                        <?php }
                            ...
                            ?> <tr style="color: red;">No se encontraron  registros.</tr> <br> <?php
                        }?>
