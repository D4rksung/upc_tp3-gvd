...
<section>
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">Vacunas/Desparasitadores asociados</h3>
                    </div>
...
function listaAsociarVacuna(inicio,fin,id){
                                ...
                                success: function(data) {
                                 ...
                                 //   alert(data.total)
                                    ...
                                    $.each( data.registros, function( key, value ) {
                                        ...
                                        if(value["cant_pautas"] == '0' ){
                                            tbl += "No cuenta con Pautas Asignadas";
                                        }else{
                                            if(value["flag_agregado"] == '0' ){
                                                tbl += "<a href='#' onclick=agregar('"+value["idFarmacoA"]+"','"+value["id"]+"','<?php echo $id;?>') data-toggle=\"tooltip\" title=\"Agregar\" ><span style=\"color: green;padding-left: 35px;\" class=\"glyphicon glyphicon-ok-sign\" >&nbsp;</span></a>";
                                            }else{
        ...
        function agregar(tipo_farmaco,farmacoAsociado,calendario){
            
                        $.ajax({
                                type: "POST",
                                url: '<?php echo getUrl().'/main/addVacunaCalendario';?>',
                                data:  {tipo_farmaco:tipo_farmaco,farmacoAsociado:farmacoAsociado,calendario:calendario},
                                dataType: "json",
                                success: function(data) {
                                    if(data == '1'){
                                    ...
                                    listaAsociarVacuna(0,10,<?php echo $id;?>);
                                        ...
                                        alert('No se pudo agregar, ya existe un farmaco igual para este calendario');
                                    }
                                }
                    });
