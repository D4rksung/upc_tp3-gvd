                ...
                <div class="row">
                    ...
                    <div class="col-md-6" id="divOrden">
                                <div class="form-group">
                                  <label class="sr-only" for="txtCod_Mod"></label>
                                  <div class="input-group">
                                    <div class="input-group-addon">Orden:<font size="2" color="red"> </font></div>
                                    <input type="text" class="form-control" required="" id="txtOrden" name="txtOrden" maxlength="2" placeholder="Ingrese el orden de la pauta" >
               ...
               <div class="col-md-6" id="divPauta">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" required="" id="txtPauta" name="txtPauta" maxlength="3" placeholder="Ingrese números maximos de 03 digitos" >
...
<section>
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista de pautas</h3>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#txtOrden').blur(function (){
            var txtOrden = $('#txtOrden').val();
            var id =  '<?php echo $idVacuna;?>';
             $.ajax({
                type: "POST",
                url: '<?php echo getUrl().'/main/validaOrden';?>',
                data:  {id:id,txtOrden:txtOrden,tipo:1},
                dataType: "json",
                success: function(data) {
                    
                    if(data == '1'){
                        alert('Ya existe el orden '+txtOrden+' registrado')
                        $('#txtOrden').val('');
                    }
                }
            });
                ...
                success: function(data) {
                    if(data == '0'){
                        $.ajax({
                            ...
                            data:  {txtPauta:txtPauta,cboPeriodo:cboPeriodo,cboTipoPauta:cboTipoPauta,id:id,txtOrden:txtOrden},
                            dataType: "json",
                            success: function(data) {
    ...
    function llenarTipoPauta(id){
        var cmb = '';
        $("#cboTipoPauta").html('');
            $.ajax({
                            type: "POST",
                            url: '<?php echo getUrl().'/main/llenarCboTipo';?>',
                            data:  {id:id},
                            dataType: "json",
                            success: function(data) {
                                    ...
                                    $.each(data,function (key,val){
                                        cmb +="<option value="+val["id"]+">"+val["nombre"]+"</option>";
                                    });
                            $("#cboTipoPauta").html(cmb);
             }
            }); 
    } 
            ...
            $.ajax({        
                                ...
                                success: function(data) {
                                    ...
                                    if(data == '1'){
                                        ...
                                        llenarTipoPauta('<?php echo $idVacuna;?>');
                                        listaPauta(0,10,'<?php echo $idVacuna;?>');
                                    }
                                    }
        ...
        function validar(flag){
               ...
               // alert(txtCalendario.length+"-"+cboEspecie+"-"+cboTipoCalendario+"-"+txtFechaInicio.length+"-"+txtFechaFin.length)
                ...
                if(flag == '1'){
                    ...
                    if( txtOrden == '' ) {  $("#divOrden").addClass('has-error') ; retorno += 1 }else{  $("#divOrden").removeClass('has-error');  retorno += 0 ;}
