	...
	$(document).ready(function() {
          ...
          //  $("#tblCalendario1").html(tbl3);
            ...
            function addSer(idMascota,idCalendario,farmaco_especie,pauta){
               callMODAL_Bootstrap_formulariosResul("my_modal_addSer", "Registrar Resultado", '<iframe src="<?php echo getUrl(); ?>/campania/addServicio/&idMascota='+idMascota+'&idCalendario='+idCalendario+'&farmaco_especie='+farmaco_especie+'&pauta='+pauta+' " width="650" height="450" scrolling="no" frameBorder="0" ></iframe>');
    ...
    function confirmaFinalizacion(){
            ...
            callMODAL_Bootstrap_Finalizacion("my_modal_Finalizacion", "Confirmación", '<h5>¿Desea finalizar la atención?</h5>');
             ...
             function callMODAL_Bootstrap_Finalizacion(id_modal,titulo, contenido) {
                ...
                modal += '</div>';
                modal += '<div class=\"modal-footer\">';
                modal += '<button type=\"button\" class=\"btn btn-primary\" id=\"modal_aceptar\" name=\"modal_aceptar\" onclick=\"location.href=\'<?php echo getUrl().'/campania/clientes';?>\'\" data-dismiss=\"modal\">Guardar</button>';
