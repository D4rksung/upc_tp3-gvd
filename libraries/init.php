...
$controllersApplication[] = 'atencion';
$controllersApplication[] = 'campania';
$controllersApplication[] = 'seguimiento';
...
function loadClass() {
	...
	require_once (ROOT . DS . 'application/controllers/main.php');
        require_once (ROOT . DS . 'application/controllers/atencion.php');
        require_once (ROOT . DS . 'application/controllers/campania.php');
        require_once (ROOT . DS . 'application/controllers/seguimiento.php');
        ...
        require_once (ROOT . DS . 'application/models/sql/AtencionDAO.php');
        require_once (ROOT . DS . 'application/models/sql/CampaniaDAO.php');
        require_once (ROOT . DS . 'application/models/sql/SeguimientoDAO.php');
        /*** ADMIN ***/
